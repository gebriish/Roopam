...
//                        BINDING FUNCTIONS                             //
//======================================================================//
void actionBindKey(const std::string& name, int key, float scale) {
  ActionBinding bind;
	bind.key = key;
...
void actionBindMouseButton(const std::string& name, int button, float scale) {
  ActionBinding bind;
...
void actionBindMouseAxis(const std::string& name, bool x_axis, 
...
void actionBindGamepadButton(const std::string& name, int button, int gamepad, float scale) {
  ActionBinding bind;
...
void actionBindGamepadAxis(const std::string& name, int axis, int gamepad,
                              float dead_zone, float scale) {
  ActionBinding bind;
